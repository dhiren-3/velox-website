  ...
  return (
    <section id="booking" className="relative bg-[#050505] px-6 py-32 lg:py-40 overflow-hidden">
      ...
      >
        ...
        <div className="w-full max-w-3xl mx-auto h-[850px] md:h-[750px] overflow-hidden border-4 border-emerald-500 shadow-[12px_12px_0px_#047857] bg-[#050505]">
      ...
      <div className="relative z-10 mt-32">
        <div className="w-full h-px bg-emerald-900/40 mb-8" />
